#!/usr/bin/env python3
"""
Simple Port Scanner for Educational Use
This script demonstrates basic networking concepts and port scanning techniques.
WARNING: Only use this on systems you own or have explicit permission to scan.
"""
